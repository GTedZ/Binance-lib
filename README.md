...
|FUNCTIONS                                                                                           |REQUIRED PARAMETERS<a href='#fParameters-Explanation'><sup>ref</sup></a> |OPTIONAL PARAMETERS<a href='#fParameters-Explanation'><sup>ref</sup></a>|OPTIONS = {} <a href='#options--'><sup>ref</sup></a>|
|:---------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------:|:-------------------------------------------------------:|:--------------:|
...
|futuresAccount()                                        <a href='#futuresAccount'><sup>ref</sup></a>|                                                                         |activePositionsOnly, activeAssets                        |recvWindow      |
